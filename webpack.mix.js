...
mix.combine('resources/css/dataTables/responsive.bootstrap.min.css', folder.dist_assets + "css/dataTables/responsive.bootstrap.min.css");
mix.combine('resources/css/dataTables/dataTables.bootstrap5.min.css', folder.dist_assets + "css/dataTables/dataTables.bootstrap5.min.css");
mix.combine('resources/css/dataTables/buttons.dataTables.min.css', folder.dist_assets + "css/dataTables/buttons.dataTables.min.css");

mix.combine('resources/js/continental/all.user.js', folder.dist_assets + "js/continental/all.user.js");
mix.combine('resources/js/continental/client.api.js', folder.dist_assets + "js/continental/client.api.js");
mix.combine('resources/js/continental/profile.page.js', folder.dist_assets + "js/continental/profile.page.js");
mix.combine('resources/js/continental/audit.logs.js', folder.dist_assets + "js/continental/audit.logs.js");

mix.combine('resources/js/SoarChangeManagement/soar.elements.js', folder.dist_assets + "js/SoarChangeManagement/soar.elements.js");
mix.combine('resources/js/SoarChangeManagement/soar.elements.details.js', folder.dist_assets + "js/SoarChangeManagement/soar.elements.details.js");
mix.combine('resources/js/SoarChangeManagement/setting.alert.js', folder.dist_assets + "js/SoarChangeManagement/setting.alert.js");
mix.combine('resources/js/SoarChangeManagement/setting.businessunit.js', folder.dist_assets + "js/SoarChangeManagement/setting.businessunit.js");
mix.combine('resources/js/SoarChangeManagement/setting.datasource.js', folder.dist_assets + "js/SoarChangeManagement/setting.datasource.js");
mix.combine('resources/js/SoarChangeManagement/setting.mandatoryautomation.js', folder.dist_assets + "js/SoarChangeManagement/setting.mandatoryautomation.js");
...
mix.combine('resources/js/jquery-3.6.0.js', folder.dist_assets + "js/jquery-3.6.0.min.js");
mix.combine('resources/js/toastify-js.js', folder.dist_assets + "js/toastify-js.js");

mix.combine('resources/js/dataTables/buttons.html5.min.js', folder.dist_assets + "js/dataTables/buttons.html5.min.js");
mix.combine('resources/js/dataTables/buttons.print.min.js', folder.dist_assets + "js/dataTables/buttons.print.min.js");
mix.combine('resources/js/dataTables/dataTables.bootstrap5.min.js', folder.dist_assets + "js/dataTables/dataTables.bootstrap5.min.js");
mix.combine('resources/js/dataTables/dataTables.buttons.min.js', folder.dist_assets + "js/dataTables/dataTables.buttons.min.js");
mix.combine('resources/js/dataTables/dataTables.responsive.min.js', folder.dist_assets + "js/dataTables/dataTables.responsive.min.js");
mix.combine('resources/js/dataTables/jquery.dataTables.min.js', folder.dist_assets + "js/dataTables/jquery.dataTables.min.js");
